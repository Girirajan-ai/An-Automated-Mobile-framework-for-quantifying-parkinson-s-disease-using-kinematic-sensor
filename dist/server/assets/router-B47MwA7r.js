import { Y as reactExports, K as isPromise, L as isRedirect, J as isNotFound, G as invariant, i as createControlledPromise, a4 as rootRouteId, M as isServer$1, x as functionalUpdate$1, c as arraysEqual, j as createLRUCache, g as compileDecodeCharMap, a6 as trimPath, a3 as rewriteBasepath, h as composeRewrites, X as processRouteTree, W as processRouteMasks, a2 as resolvePath, e as cleanPath, a8 as trimPathRight, V as parseHref, s as executeRewriteInput, H as isDangerousProtocol, Z as redirect, w as findSingleMatch, n as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, d as buildRouteBranch, F as interpolatePath, U as nullReplaceEqualDeep, $ as replaceEqualDeep$1, Q as last, m as decodePath, u as findFlatMatch, v as findRouteMatch, E as hasKeys, t as executeRewriteOutput, p as encodePathLikeUrl, a7 as trimPathLeft, N as joinPaths, aa as useRouter, o as dummyMatchContext, S as matchContext, z as getDefaultExportFromCjs, a0 as requireReactDom, r as exactPathTest, _ as removeTrailingSlash, R as React, P as jsxRuntimeExports, I as isModuleNotFoundError, a9 as useHydrated, q as escapeHtml, y as getAssetCrossOrigin, B as getScriptPreloadAttrs, b as appendUniqueUserTags, a1 as resolveManifestCssLink, O as Outlet } from "./server-nsipvdQg.js";
...
const appCss = "/assets/styles-Bmetcyuj.css";
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "mt-6 inline-block rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90", children: "Go home" })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "rounded-md border px-4 py-2 text-sm font-medium hover:bg-accent/10", children: "Go home" })
    ] })
  ] }) });
}
const Route$d = createRootRouteWithContext()({
  head: () => ({
    ...
    links: String(appCss).length > 0 ? [{ rel: "stylesheet", href: appCss }] : []
  }),
...
const $$splitComponentImporter$b = () => import("./signup-C3hd-0aE.js");
const Route$b = createFileRoute("/signup")({
  head: () => ({
    meta: [{
      title: "Create account — PDMS"
    }, {
      name: "description",
      content: "Create a PDMS patient account."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./login-D-07a_pp.js");
const Route$a = createFileRoute("/login")({
  validateSearch: (search) => ({
    email: typeof search.email === "string" ? search.email : void 0,
    signedup: typeof search.signedup === "string" ? search.signedup : void 0
  }),
  head: () => ({
    meta: [{
      title: "Sign in — PDMS"
      ...
      name: "description",
      content: "Sign in to PDMS."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./_authenticated-dBuh9RUL.js");
...
const $$splitComponentImporter$8 = () => import("./index-D45ZVyaA.js");
const Route$8 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Screen for Parkinson's symptoms in minutes using only your smartphone."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./auth.callback-BuIn2gZq.js");
const Route$7 = createFileRoute("/auth/callback")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./_authenticated.typing-C7r15MfG.js");
const Route$6 = createFileRoute("/_authenticated/typing")({
  head: () => ({
    meta: [{
      title: "Typing test — PDMS"
    }, {
      name: "description",
      content: "Typing speed and rhythm test."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./_authenticated.tremor-CzrRPBr_.js");
const Route$5 = createFileRoute("/_authenticated/tremor")({
  head: () => ({
    meta: [{
      title: "Tremor test — PDMS"
    }, {
      name: "description",
      content: "Hold-still tremor test."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./_authenticated.rigidity-DDT2Ebac.js");
const Route$4 = createFileRoute("/_authenticated/rigidity")({
  head: () => ({
    meta: [{
      title: "Rigidity test — PDMS"
    }, {
      name: "description",
      content: "Wrist and arm movement test."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./_authenticated.results-Cp_I64px.js").then((n) => n._);
const Route$3 = createFileRoute("/_authenticated/results")({
  head: () => ({
    meta: [{
      title: "Results — PDMS"
    }, {
      name: "description",
      content: "Prediction, trends, and PDF report."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./_authenticated.profile-CoKjLUHE.js");
const Route$2 = createFileRoute("/_authenticated/profile")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your patient profile."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_authenticated.dashboard-r4QG-0yj.js");
const Route$1 = createFileRoute("/_authenticated/dashboard")({
  head: () => ({
    meta: [{
      title: "Dashboard — PDMS"
    }, {
      name: "description",
      content: "Run tests and review your screening results."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./_authenticated.bradykinesia-cnWlxtq5.js");
const Route2 = createFileRoute("/_authenticated/bradykinesia")({
  head: () => ({
    meta: [{
      title: "Bradykinesia test — PDMS"
    }, {
      name: "description",
      content: "Finger-tapping test."
    }]
  }),
...
const AuthCallbackRoute = Route$7.update({
  id: "/auth/callback",
  path: "/auth/callback",
  getParentRoute: () => Route$d
});
const AuthenticatedTypingRoute = Route$6.update({
  id: "/typing",
  path: "/typing",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedTremorRoute = Route$5.update({
  id: "/tremor",
  path: "/tremor",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedRigidityRoute = Route$4.update({
  id: "/rigidity",
  path: "/rigidity",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedResultsRoute = Route$3.update({
  id: "/results",
  path: "/results",
  getParentRoute: () => AuthenticatedRoute
});
...
const AuthenticatedBradykinesiaRoute = Route2.update({
  id: "/bradykinesia",
  path: "/bradykinesia",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedRouteChildren = {
  AuthenticatedBradykinesiaRoute,
  AuthenticatedDashboardRoute,
  AuthenticatedProfileRoute,
  AuthenticatedResultsRoute,
  AuthenticatedRigidityRoute,
  AuthenticatedTremorRoute,
  AuthenticatedTypingRoute
};
