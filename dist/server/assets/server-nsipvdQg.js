...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./tanstack-start-manifest-v-K_V73znz.js");
...
const manifest = {
  "7b0d8b83c169382755a8b90a537f3ae4f4e2e731ec0946cf9aeb280c5eeeb7a9": {
    functionName: "generatePredictionSummary_createServerFn_handler",
    importer: () => import("./prediction.functions-Bh-FJX2x.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B47MwA7r.js").then((n2) => n2.r),
    import("./start-C6dc6qr5.js"),
...
export {
  ...
  nullReplaceEqualDeep as U,
  parseHref as V,
  processRouteMasks as W,
  processRouteTree as X,
  reactExports as Y,
  redirect as Z,
  removeTrailingSlash as _,
  React$1 as a,
  requireReactDom as a0,
  resolveManifestCssLink as a1,
  resolvePath as a2,
  rewriteBasepath as a3,
  rootRouteId as a4,
  server as a5,
  trimPath as a6,
  trimPathLeft as a7,
