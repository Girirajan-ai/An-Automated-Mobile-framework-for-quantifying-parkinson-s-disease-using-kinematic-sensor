export function getMotionSupport() {
  const motionEvent = typeof DeviceMotionEvent !== "undefined" ? DeviceMotionEvent : null;
  const requiresPermission = !!motionEvent && typeof (motionEvent as any).requestPermission === "function";
...
export function motionUnavailableMessage() {
